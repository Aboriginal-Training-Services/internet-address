...
export const regulationCourses: CourseData[] = [
  ...
  },
  {
    ...
    duration: "Self-paced",
    capacity: "15 students",
    description: "Comprehensive online regulatory training for advanced VLOS operations including complex airspace and night operations.",
    features: [
...
export const applicationCourses: CourseData[] = [
  ...
  },
  {
    ...
    duration: "5 Days",
    capacity: "6 students",
    description: "Advanced apprenticeship program covering mapping, surveying, LIDAR, photogrammetry, and inspection applications.",
    features: [
